...
describe('<ButtonLink />', () => {
    it('should match snapshot', () => {
        const { container } = render(
            <ButtonLink url="/relative/path">Hello World</ButtonLink>,
        );
    ...
    each([
        ...
        (variant, expectedClassName) => {
            const { queryByTestId, container } = render(
                <ButtonLink url="/relative/path" variant={variant}>
                    Hello World
                </ButtonLink>,
            );
    ...
    each([
        ...
        (size, expectedClassName) => {
            const { queryByTestId, container } = render(
                <ButtonLink url="/relative/path" size={size}>
                    Hello World
                </ButtonLink>,
            );
    ...
    it('should render the wide class when wide prop is added', () => {
        const { queryByTestId, container } = render(
            <ButtonLink url="/relative/path" wide>
                Hello World
            </ButtonLink>,
        );
    ...
    it('should render the wide class when disabled prop is added', () => {
        const { queryByTestId, container } = render(
            <ButtonLink url="/relative/path" disabled>
                Hello World
            </ButtonLink>,
        );
